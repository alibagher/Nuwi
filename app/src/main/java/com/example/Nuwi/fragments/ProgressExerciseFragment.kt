 ...
 * Use the [ProgressExerciseFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ProgressExerciseFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        vview = inflater.inflate(R.layout.fragment_progress_exercise, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment ProgressExerciseFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ProgressExerciseFragment().apply {
