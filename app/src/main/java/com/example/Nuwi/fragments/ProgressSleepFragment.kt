 ...
 * Use the [ProgressSleepFragment.newInstance] factory method to
 * create an instance of this fragment.
 */
class ProgressSleepFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        vview = inflater.inflate(R.layout.fragment_progress_sleep, container, false)
    ...
    companion object {
         ...
         * @return A new instance of fragment ProgressSleepFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ProgressSleepFragment().apply {
